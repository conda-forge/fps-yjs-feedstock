...
Development: https://github.com/jupyter-server/jupyverse/plugins/yjs
...
Once the `conda-forge` channel has been enabled, `fps-yjs` can be installed with:

```
conda install fps-yjs
```

It is possible to list all of the versions of `fps-yjs` available on your platform with:
